...
<html lang="en">
    <head>
        ...
        <title>Logs pipeline on AWS </title>
                    ...
                    <div class="columns is-vcentered">
                        <div class="column is-4 hero-caption">
                            ...
                            <h2 class="subtitle is-5 light-text pt-10 pb-10">
                               This solution send application logs to a nice Kibana dashboard through an AWS pipeline of services and use Cognito to enable Google authentication.  Java Spring application, Rails, Cloudwatch (Log groups, logs streams), Lambda, Elastic Search, Kibana, Cognito-OAuth2-Google.
                            </h2>
                            <p class="pt-10 pb-10">
                        ...
                        <div class="column is-9 is-offset-1">
                            <!-- Hero mockup -->
                            <figure class="image">
                                <img class="levitate" src="assets/images/aws-cloudwatch-kibana2.png" alt="">
                            </figure>
                            <!-- /Hero mockup -->
                        </div>
                    </div>
