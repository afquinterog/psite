                        ...
                        <div class="column">
                            ...
                            <div class="flex-card light-bordered hover-inset ">
                                <div class="flex-card-header">
                                    ...
                                    <div class="header-info">
                                        <div class="header-title">ServerMonitor</div>
                                        <div class="header-subtitle">Laravel / Nova / Php / Mysql</div>
                                    </div>
                                    <div class="header-control ml-auto">
                                        <!-- <a href='http://servers.oru.com.co/app' target="_blank"><i style='font-size:2rem' class="material-icons">call_made</i></a> -->
                                    </div>
                        ...
                        <div class="column">
                            ...
                            <div class="flex-card light-bordered hover-inset ">
                                <div class="flex-card-header">
                                    ...
                                    <div class="header-info">
                                        <div class="header-title">Trygps</div>
                                        <div class="header-subtitle">Laravel / Php / Mysql / OpenGts</div>
                                    </div>
                                    <div class="header-control ml-auto">
                                        <!-- <a href='https://trygps.com.co' target="_blank"><i style='font-size:2rem' class="material-icons">call_made</i></a> -->
                                    </div>
                                </div>
                                <div class="card-body is-small">
                                    <div class="content">
                        ...
                        <div class="column">
                            ...
                            <div class="flex-card light-bordered hover-inset ">
                                <div class="flex-card-header">
                                    ...
                                    <div class="header-info">
                                        <div class="header-title">The Connectory</div>
                                        <div class="header-subtitle">Php / Mysql / Mongo</div>
                                    </div>
                                    <div class="header-control ml-auto">
                            ...
                            <div class="mr-10 min-height">
                                <div class="flex-card light-bordered hover-inset ">
                                    <div class="flex-card-header">
                                        ...
                                        <div class="header-info">
                                            <div class="header-title">StarPortal</div>
                                            <div class="header-subtitle">Php / Mysql / Mongo/ Solr</div>
                                        </div>
                                        <div class="header-control ml-auto">
                                            <!-- <a href='https://starportal.edu.au' target="_blank"><i style='font-size:2rem' class="material-icons">call_made</i></a> -->
                                        </div>
                                    </div>
                                    <div class="card-body is-small">
                                        <div class="content">
                                        ...
                                        <div class="has-text-right">
                                            <a href='https://starportal.edu.au' target="_blank" class="button btn-align btn-outlined accent-btn rounded raised">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mr-10 min-height">
                                <div class="flex-card light-bordered hover-inset ">
                                    <div class="flex-card-header">
                                        ...
                                        <div class="header-info">
                                            <div class="header-title">Tigo/Une Mobile App</div>
                                            <div class="header-subtitle">Php / Mysql / Oracle PLSQL</div>
                                        </div>
                                        <div class="header-control ml-auto">
                            ...
                            <div class="mr-10 ">
                                <div class="flex-card light-bordered hover-inset ">
                                    <div class="flex-card-header">
                                        ...
                                        <div class="header-info">
                                            <div class="header-title">ScienceFestivals</div>
                                            <div class="header-subtitle">Wordpress / Mysql / Solr </div>
                                        </div>
                                        <div class="header-control ml-auto">
                                            <!-- <a href='https://sciencefestivals.org' target="_blank"><i style='font-size:2rem' class="material-icons">call_made</i></a> -->
                                        </div>
                                    </div>
                                    <div class="card-body is-small">
                                        <div class="content">
            ...
            <div class="container">
                ...
                <div class="section-title-wrapper has-text-centered">
                    ...
                    <h4>
                        ...
                        <div class="content">
                            <p>I consider myself passionate on application development and new technologies some of my
                            hobbies are play video games and soccer.</p>
                        </div>
                    </h4>
                </div>
