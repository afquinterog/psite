...
<html lang="en" class="no-js">
  <head>
    ...
    <meta name="description" content="Andres Quintero / CV / vCard" />
    <meta name="keywords" content="vcard, developer, senior, hire" />
          ...
          <header id="site_header" class="header mobile-menu-hide">
            <div class="header-content">
              <div class="header-photo">
                <img src="img/main_photo.jpeg" alt="Andrés Quintero">
              </div>
              <div class="header-titles">
                <h2>Andrés Quintero</h2>
            ...
            <div class="social-links">
              <ul>
                <li><a href="https://www.linkedin.com/in/afquinterog/" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                <!-- <li><a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a></li> -->
                <li><a href="https://x.com/anndresquintero" target="_blank"><i class="fab fa-twitter"></i></a></li>
              </ul>
            </div>
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="title-block">
                          ...
                          <div class="owl-carousel text-rotation">
                            ...
                            <div class="item">
                              <div class="sp-subtitle">AWS Certified Solutions Architect</div>
                            </div>
                            <div class="item">
                                <div class="sp-subtitle">Msc Software Project Management and Administration</div>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-7">
                        <p style="text-align: justify;">
                            I’m a Senior Software Engineer with over 15 years of experience, specializing in PHP, Laravel, Java Spring, Vue and AWS.
                            My expertise extends to both front-end and back-end development, with a strong focus on Test-Driven Development and DevOps practices.
                            My passion for continuous learning is demonstrated by my pursuit of industry certifications including
                            AWS Certified Solutions Architect, Zend PHP Certified Programmer, Oracle Certified Java Programmer and
                            a Master’s degree in Software Project Management.
                            I also regularly attend industry conferences, including Laracon Online and AWS re:Invent.
                        </p>
                    </div>
                      ...
                      <div class="info-list">
                        <ul>
                          <li>
                            ...
                            <span class="value">rocoutp@gmail.com</span>
                          </li>

                          <li>
                            <span class="title">Phone</span>
                            <span class="value">+57 312 752 9911</span>
                          </li>

                          <li>
                            <span class="title">Residence</span>
                            <span class="value">LATAM - Co</span>
                          </li>

                          <li>
                            <span class="title">Languages</span>
                            <span class="value">Spanish / English</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                        ...
                        <div class="info-list-w-icon">
                          <div class="info-block-w-icon">
                            ...
                            <div class="ci-text">
                              <h4>Devops</h4>
                              <p style="text-align: justify;">
                                I am able to optimize development workflows to accelerate feature delivery,
                                enabling rapid integration of user feedback.
                              </p>
                            </div>
                          </div>
                          <div class="info-block-w-icon">
                            <div class="ci-icon">
                              ...
                              <h4>Web Design</h4>
                              <p style="text-align: justify;">
                                I continuously stay up to date with the latest web features and industry trends to ensure my applications meet current standards.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="info-list-w-icon">
                          <div class="info-block-w-icon">
                            ...
                            <div class="ci-text">
                              <h4>Iterative</h4>
                              <p style="text-align: justify;">
                              Applying an iterative approach I am able to reduce batch size and quickly identify
                          ...
                          <div class="info-block-w-icon">
                            <div class="ci-icon">
                              ...
                              <h4>Management</h4>
                              <p style="text-align: justify;">
                                I architect and design features or epics into manageable tasks, ensuring streamlined and immediate delivery from day one.
                              </p>
                    ...
                    <div class="col-xs-12 col-sm-12">
                      <div class="testimonials owl-carousel">
                        ...
                        <div class="testimonial">
                          ...
                          <div class="text">
                            <p>
                              I have worked with Andrés for over six years, and he consistently delivers excellent work.
                              His versatility is a significant asset, as he adeptly handles both development tasks and server configuration.
                            </p>
                          </div>

                          <div class="author-info">
                            <h4 class="author">Trevor Nesbit</h4>
                            <h5 class="company">Venture</h5>
                            <div class="icon">
                        ...
                        <div class="testimonial">
                          ...
                          <div class="text">
                            <p>
                            Andrés is a disciplined and organized engineer who played a crucial role in our migration from an
                            old platform to a new one. Working with him is a pleasure,
                            as he consistently maintains thorough documentation of his work.
                            </p>
                          </div>

                          <div class="author-info">
                            <h4 class="author">Andrew Hart</h4>
                            <h5 class="company">AET</h5>
                            <div class="icon">
                              <i class="fas fa-quote-right"></i>
                            </div>
                          </div>
                        ...
                        <!-- End of Testimonial 2 -->
                         ...
                         <div class="testimonial">
                          ...
                          <div class="text">
                            <p>
                            Andrés is an exceptional engineer who successfully architected and developed a GPS Tracker application from scratch within just a few months.
                            He was able to met our company’s high standards for scalability and security.
                            </p>
                          </div>

                          <div class="author-info">
                            <h4 class="author">Fernando Aristizabal</h4>
                            <h5 class="company">OnOff Online Solutions</h5>
                            <div class="icon">
                              <i class="fas fa-quote-right"></i>
                            </div>
                          </div>
                ...
                <div class="section-content">
                  ...
                  <div class="row">
                      ...
                      <div class="timeline timeline-second-style clearfix">
                        <div class="timeline-item clearfix">
                          <div class="left-part">
                            ...
                            <span class="item-company">Autonomous University of Manizales</span>
                          </div>
                          <div class="divider"></div>
                          <div class="right-part">
                            <h4 class="item-title">M.D Software Project Management</h4>
                            <p></p>
                          </div>
                        </div>
                        ...
                        <div class="timeline-item clearfix">
                          <div class="left-part">
                            ...
                            <span class="item-company">Technological University</span>
                          </div>
                          <div class="divider"></div>
                          <div class="right-part">
                            <h4 class="item-title">B.D Systems Engineer</h4>
                            <p></p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="timeline timeline-second-style clearfix">
                        <div class="timeline-item clearfix">
                          <div class="left-part">
                            ...
                            <span class="item-company">American Estate & Trust</span>
                          </div>
                          <div class="divider"></div>
                          <div class="right-part">
                            <h4 class="item-title">Senior Software Engineer</h4>
                            <p>Developed an application to enable the investment of retirement funds across various options.</p>
                          </div>
                        </div>
                        ...
                        <div class="timeline-item clearfix">
                          <div class="left-part">
                            ...
                            <span class="item-company">LawnStarter</span>
                          </div>
                          <div class="divider"></div>
                          <div class="right-part">
                            <h4 class="item-title">Senior Software Engineer </h4>
                            <p>Developed an application to manage the lawn care marketplace, including administrative tasks and mobile applications for LawnStarter.</p>
                          </div>
                        </div>
                        ...
                        <div class="timeline-item clearfix">
                          ...
                          <div class="divider"></div>
                          <div class="right-part">
                            <h4 class="item-title">DevOps - Software Engineer </h4>
                            <p>Responsible for developing and deploying applications that streamline investment management processes, using a robust suite of AWS services.</p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-xs-12 col-sm-5">
                      <!-- Design Skills -->
                      <div class="block-title">
                        <h3>Engineer <span>Skills</span></h3>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/certifications/aws.jpeg" alt="AWS logo">
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/certifications/php.png" alt="Php logo">
                        </div>

                        <div class="certi-content">
                          <div class="certi-title">
                            <h4>Zend Php Certified Programmer</h4>
                          </div>
                          <div class="certi-id">
                            <span>Zend</span>
                          </div>
                    ...
                    <!-- End of Certificate 2 -->
                     ...
                     <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/certifications/oracle.png" alt="Oracle logo">
                        </div>

                        <div class="certi-content">
                          <div class="certi-title">
                            <h4>Oracle Certified Java Programmer</h4>
                          </div>
                          <div class="certi-id">
                            <span>JDK 1.5</span>
                          </div>
                    ...
                    <!-- End of Certificate 3 -->
                     ...
                     <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/certifications/sei.png" alt="SEI logo">
                        </div>

                        <div class="certi-content">
                          <div class="certi-title">
                            <h4>SEI PSP Certified Developer</h4>
                          </div>
                          <div class="certi-id">
                            <span>SEI PSP</span>
                          </div>
