...
<html lang="en">
    <head>
        ...
        <title>Server Monitor Application </title>
        <meta name="description" content="Service to monitor ubuntu based servers and receive alerts.">
        ...
        <div class="container">
            <div class="columns is-vcentered">
                <div class="column is-6 has-text-centered">
                    ...
                    <img class="featured-svg levitate" src="assets/images/server-metrics.png" alt="">
                    <!-- /Featured illustration -->
                </div>
                <!-- Content -->
                <div class="column is-4 is-offset-1">
                    ...
                    <span class="section-feature-description">Keep track of your server status with real time graphics .</span>
        ...
        <div class="container is-reverse-skewed-sm">
            ...
            <div class="columns is-vcentered">
                ...
                <div class="column is-4 is-offset-2">
                    ...
                    <h2 class="title quick-feature is-handwritten">
                        Filter server by different options
                        <span class="bg-number text-bold"></span>
                    </h2>
                    <div class="title-divider is-small"></div>
                    <span class="section-feature-description">The user has the option to group and filters the servers for easy of use.</span>
                    <div class="pt-10 pb-10">
                        <a href="#" class="button btn-align btn-more is-link color-primary">
                            <!-- Learn more about this <i class="sl sl-icon-arrow-right"></i> -->
                        </a>
                ...
                <div class="column is-6 has-text-centered">
                    <!-- Featured illustration -->
                    <img class="featured-svg levitate" src="assets/images/server-filters.png" alt="">
                    <!-- /Featured illustration -->
                </div>
            </div>
        </div>
    ...
    <section class="section is-medium">
        <div class="container">
            <div class="columns is-vcentered">
                <div class="column is-6 has-text-centered">
                    <!-- Featured illustration -->
                    <img class="featured-svg levitate" src="assets/images/server-tasks.png" alt="">
                    <!-- /Featured illustration -->
                </div>
                <!-- Content -->
                <div class="column is-4 is-offset-1">
                    ...
                    <div class="title-divider is-small"></div>
                    <span class="section-feature-description">Configure shell task's to execute common operations on the servers and reuse it .</span>
                    <div class="pt-10 pb-10">
                        <a href="#" class="button btn-align btn-more is-link color-primary">
                            <!-- Learn more about this <i class="sl sl-icon-arrow-right"></i> -->
                        </a>
        ...
        <div class="container is-reverse-skewed-sm">
            ...
            <div class="columns is-vcentered">
                ...
                <div class="column is-4 is-offset-2">
                    ...
                    <div class="title-divider is-small"></div>
                    <span class="section-feature-description">Configure email/SMS alerts on disk usage, connections, etc..</span>
                    <div class="pt-10 pb-10">
                        <a href="#" class="button btn-align btn-more is-link color-primary">
                            <!-- Learn more about this <i class="sl sl-icon-arrow-right"></i> -->
                        </a>
                ...
                <div class="column is-6 has-text-centered">
                    <!-- Featured illustration -->
                    <img class="featured-svg levitate" src="assets/images/server-alerts.png" alt="">
                    <!-- /Featured illustration -->
                </div>
            </div>
        </div>
